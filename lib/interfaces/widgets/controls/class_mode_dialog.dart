...
class ClassModeSelectionDialog extends StatefulWidget {
  ...
  State<ClassModeSelectionDialog> createState() =>
      ClassModeSelectionDialogState();
}

class ClassModeSelectionDialogState extends State<ClassModeSelectionDialog> {
  int _warmUpCount = 4;
  int _earlyCount = 4;
  int _midCount = 2;
  int _finalCount = 1;
          ...
          child: Column(
            ...
            children: [
              ...
              PhaseConfigRow(
                label: 'Warm-up (30s)',
                value: _warmUpCount,
                onChanged: (value) => setState(() => _warmUpCount = value),
              ),
              PhaseConfigRow(
                label: 'Early Study (1m)',
                value: _earlyCount,
                onChanged: (value) => setState(() => _earlyCount = value),
              ),
              PhaseConfigRow(
                label: 'Mid Study (5m)',
                value: _midCount,
                onChanged: (value) => setState(() => _midCount = value),
              ),
              PhaseConfigRow(
                label: 'Final Study (10m)',
                value: _finalCount,
                onChanged: (value) => setState(() => _finalCount = value),
              ),
              const SizedBox(height: 8),
              Row(
                children: [
                  Checkbox(
                    value: _hasBreak,
                    onChanged: (value) =>
                        setState(() => _hasBreak = value ?? false),
                  ),
                    ...
                    SizedBox(
                      ...
                      child: DropdownButton<int>(
                        ...
                        items: [3, 5, 10]
                            ...
                            .toList(),
                        onChanged: (value) {
                          if (value != null) setState(() => _breakMinutes = value);
                        },
                      ),
                    ),
                  ],
